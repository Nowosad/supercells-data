...
plot(evi[[1]], main = "50 km step (map units)", col = rev(cols))
plot(st_geometry(sc_50km), add = TRUE, border = "red", lwd = 0.6)

plot(evi[[1]], main = "30 km step (tuned compactness)", col = rev(cols))
...
#| fig-height: 8
#| layout-ncol: 2
plot(evi[[1]], main = "30 km tuned compactness", col = rev(cols))
plot(st_geometry(sc_30km), add = TRUE, border = "yellow", lwd = 0.6)

plot(evi[[1]], main = "30 km auto compactness", col = rev(cols))
