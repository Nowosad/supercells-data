...
pol_border_2180 = project(pol_border, "EPSG:2180")
pol_border$value = 0
pol_border_raster = rasterize(pol_border_2180, r_2020[[1]], field = 0)
plot(pol_border_raster)
pol_border_raster

r_2020_2 = ifel(is.na(r_2020), pol_border_raster, r_2020)

writeRaster(
    r_2020_2,
    filename = "data/poland_evi_2020.tif",
    overwrite = TRUE,
    gdal = "COG",
    wopt = list(
        gdal = c(
